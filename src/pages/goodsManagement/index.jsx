...
export default function GoodsManagement(props) {
  ...
  const clickAddBtn = () => {
    navigateTo({
      url: `/pages/goodsManagementDetail/index?process_id=${props?.process_id}`,
    });
  }
          ...
          {list.map((a) => {
            ...
            return <View key={a.id} className="list">
              ...
              <View className="bottom">
                ...
                <View className="right">
                  <Button plain hairline round type="info" size="mini" onClick={()=>clickDeleteBtn(a.id)}>编辑商品</Button>
